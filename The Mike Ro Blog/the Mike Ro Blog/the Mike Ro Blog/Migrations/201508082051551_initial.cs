    ...
    public partial class initial : DbMigration
    {
        public override void Up()
        {
            CreateTable(
                ...
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Followee_Id, cascadeDelete: false)
                .ForeignKey("dbo.AspNetUsers", t => t.Follower_Id, cascadeDelete: false)
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        Text = c.String(maxLength: 151),
                        PostedOn = c.DateTime(nullable: false),
                        Poster_Id = c.String(nullable: false, maxLength: 128),
                    })
                .PrimaryKey(t => t.Id)
                .ForeignKey("dbo.AspNetUsers", t => t.Poster_Id, cascadeDelete: false)
                .Index(t => t.Poster_Id);
